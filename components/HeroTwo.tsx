...
// Variant 2 hero — starts as a copy of the original; edit freely to diverge.
export default function HeroTwo() {
  return (
    ...
    >
      ...
      >
        {/* Ripples: exact logo contour, radiating from the logo's center */}
        <Ripples count={8} className="absolute inset-0" />
